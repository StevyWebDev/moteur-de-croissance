 ...
 * @UniqueEntity(fields={"email"}, message="Cette adresse email est déjà utilisé pour un autre compte.")
 */
class User implements UserInterface
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=CompanyNotice::class, mappedBy="user", orphanRemoval=true)
     */
    ...
    public function removeCompanyNotice(CompanyNotice $companyNotice): self
    {
        if ($this->companyNotices->removeElement($companyNotice)) {
            // set the owning side to null (unless already changed)
            if ($companyNotice->getUser() === $this) {
                $companyNotice->setUser(null);
            }
        }
